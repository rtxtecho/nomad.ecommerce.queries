...
namespace nomad_ecommerce_query.business
{
    public class sql_code
    {
        ...
        {
            string conn_str = "Data Source=tcp:s20.winhost.com;Initial Catalog=DB_121607_nomadsq;" +
                "User ID=DB_121607_nomadsq" + "_user" +
               "; Password=nomad;Integrated Security=False;";
        ...
        public static double
                    get_n(SqlDataReader SDR, string column
                         )
        {
            try
            {
